...
\item {\bf{Step 2}} Detect outliers: As explained in \ref{ch3_outlier}, we detect functional outliers in the dataset. 
\item {\bf{Step 3}} Template estimation: 
\item {\bf{Step 4}} Registration with varying roughness penalty: 
\end{itemize}
