...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.42,page=1]{Plots/MF_Frag3.pdf}
\includegraphics[scale=0.42,page=2]{Plots/MF_Frag3.pdf}
\end{center}
\caption{{\emph{M. florum}} Interval 3}
\label{fig:Fig2_MF_Frag3}
\end{figure}
